      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
        <div className="container mx-auto pt-8 pb-12 px-4 md:px-8">
          ...
          <div className="mb-8 flex items-center gap-4">
            <div className="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
            {/* Form Section */}
            <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-purple-100 hover:shadow-2xl transition-shadow duration-300">
              <div className="mb-6">
              ...
              <form onSubmit={generateRoadmap} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all duration-200 hover:border-purple-300 bg-gray-50 focus:bg-white"
                    required
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all duration-200 hover:border-purple-300 bg-gray-50 focus:bg-white cursor-pointer"
                  >
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows="5"
                    className="w-full px-4 py-3.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all duration-200 hover:border-purple-300 bg-gray-50 focus:bg-white resize-none"
                    required
                  />
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-purple-500 via-purple-600 to-blue-600 text-white py-4 rounded-xl font-semibold text-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 mt-8"
                >
                  {loading ? (
                    <>
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-purple-100 overflow-hidden">
              {loading ? (
                ...
                <div>
                  ...
                  <div className="bg-gradient-to-r from-purple-500 via-purple-600 to-blue-600 px-8 py-6">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      ...
                      <button
                        onClick={downloadPDF}
                        className="flex items-center gap-2 bg-white text-purple-600 px-6 py-3 rounded-xl hover:bg-purple-50 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl hover:scale-105 active:scale-95"
                      >
                          ...
                          if (hasBold) {
                            ...
                            return (
                              <div key={index} className="flex items-start gap-3 ml-6 my-2">
                                <span className="text-purple-500 mt-1.5 text-sm">●</span>
                ...
                <div className="flex flex-col items-center justify-center h-full min-h-[500px] text-center px-8">
                  <div className="w-32 h-32 bg-gradient-to-br from-purple-100 to-blue-100 rounded-3xl flex items-center justify-center mb-6">
                    <LuMap className="text-6xl text-purple-500" />
                  </div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-3">
