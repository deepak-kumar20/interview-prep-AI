...
const InterviewPrep = () => {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="container mx-auto max-w-7xl pt-8 pb-8 px-6 md:px-8 lg:px-12">
        <h2 className="text-xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent mb-2">
          Interview Q & A
        </h2>
        <p className="text-sm text-gray-500 mb-6">
          Expand each question to view detailed answers and explanations
        </p>
                    ...
                    {!isLoading &&
                      sessionData?.questions?.length === index + 1 && (
                        <div className="flex items-center justify-center mt-5">
                          <button
                            className="flex items-center gap-3 text-sm text-white font-medium bg-black px-5 py-2 mr-2 rounded text-wrap cursor-pointer"
